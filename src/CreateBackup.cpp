...
void writeHash(QFile &output_file, const QString &file)
{
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to open file:") + file);
        return;
    }
...
void copyFile(const QString &source, const QString &destination)
{
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to open source file:") + source);
        return;
    }
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to create destination file:") + destination);
        return;
    }
...
void processFiles(const QString &path, const QString &domainString, const QString &outputDir)
{
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to open output file"));
        return;
    }
...
bool createDirectory(const QString &dirPath)
{
    try
    {
        ...
        {
            LogHelper::getInstance()->addlog(QObject::tr("Failed to create directory."));
            return false;
        }
    }
    catch (const std::exception &ex)
    {
        LogHelper::getInstance()->addlog(QObject::tr( "Failed to create directory:") + ex.what());
        return false;
    }
}
...
bool removeDirectoryIfExists(const QString &dirPath)
{
    if (QFileInfo::exists(dirPath) && QFileInfo(dirPath).isDir())
    {
        ...
        {
            LogHelper::getInstance()->addlog(QObject::tr("Failed to remove directory:") + ex.what());
            return false;
        }
    }
    return false;
...
bool CreateBackup::createBackup(const QString& indir, const QString& outdir)
{
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to create output file"));
        return false;
    }
...
<dict>
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to create Info.plist file"));
        return false;
    }
...
<dict>
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to create Status.plist file"));
        return false;
    }
...
<dict>
    ...
    {
        LogHelper::getInstance()->addlog(QObject::tr("Failed to create Manifest.plist file"));
        return false;
    }
